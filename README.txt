...
-A aba de rotina deve conter 7 (uma por dia da semana) rotinas de treino customizáveis com até 5 treinos disponiveis. Cada treino, a depender de sua propriedade,
possui as seguintes caracteristicas:
    ...
    -Descrição de guia básico
    -Imagem/vídeo guia básico
    -Anotações (notas deixadas pelo própio usuário, a fim de ressaltar detalhes e/ou manter arquivado a experiência com o treino)
...
-A aba de perfil...[CONCLUIR IDEIA]